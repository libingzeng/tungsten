#include "PfMultiplexedMltTracer.hpp"

#include "sampling/UniformSampler.hpp"

namespace Tungsten {

PfMultiplexedMltTracer::PfMultiplexedMltTracer(TraceableScene *scene, const PfMultiplexedMltSettings &settings, uint32 threadId,
...
void PfMultiplexedMltTracer::tracePaths(LightPath & cameraPath, PathSampleGenerator & cameraSampler,
...
int PfMultiplexedMltTracer::evalSample(LightPath & cameraPath, PathSampleGenerator & cameraSampler,
                                     LightPath &emitterPath, PathSampleGenerator &emitterSampler,
...
void PfMultiplexedMltTracer::traceCandidatePath(LightPath &cameraPath, LightPath &emitterPath,
...
void PfMultiplexedMltTracer::startSampleChain(int s, int t, float luminance, UniformSampler &cameraReplaySampler,
...
PfLargeStepTracker PfMultiplexedMltTracer::runSampleChain(int pathLength, int chainLength,
        PfMultiplexedStats &stats, float luminanceScale)
{
