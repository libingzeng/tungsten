#ifndef PFWRITABLEMETROPOLISSAMPLER_HPP_
#define PFWRITABLEMETROPOLISSAMPLER_HPP_
...
class PfWritableMetropolisSampler : public WritablePathSampleGenerator
{
...
public:
    PfWritableMetropolisSampler(bool gaussian, UniformSampler *helperGenerator, int numBounces)
    ...
    PfWritableMetropolisSampler(const PfWritableMetropolisSampler &o)
...
#endif /* PfWRITABLEMETROPOLISSAMPLER_HPP_ */
