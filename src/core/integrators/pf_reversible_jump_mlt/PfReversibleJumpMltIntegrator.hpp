#ifndef PFREVERSIBLEJUMPMLTINTEGRATOR_HPP_
#define PFREVERSIBLEJUMPMLTINTEGRATOR_HPP_
...
class PfReversibleJumpMltIntegrator : public Integrator
{
    ...
    std::vector<std::unique_ptr<PfReversibleJumpMltTracer>> _tracers;
...
#endif /* PFREVERSIBLEJUMPMLTINTEGRATOR_HPP_ */
